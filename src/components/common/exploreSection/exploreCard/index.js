...
const ExploreCard = ({restaurant}) => {
    ...
    const approxPrice= restaurant?.info?.info?.cfo?.text;
  ...
  return (
    <div className="explore-card cur-po">
        ...
        <div  className="res-row">
            ...
            {rating && (
                <div className="res-rating absolute center"> {rating} <i class="fa-solid fa-star absolute-center "></i></div>
            )}
        </div>
        ...
        {bottomContainers.length >0 && <div>
             <div className=" card-seprator"> </div>
                <div className="explore-bottom">
                   <img src={bottomContainers[0]?.image?.url} style={{height: "18px"}} alt=""/>
                   <div className="res-bottom">{bottomContainers[0]?.text}</div>
                </div>
             </div>
            }
    </div>
